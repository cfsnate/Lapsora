...
- [x] 02-02-PLAN.md — Backend integration and recording status API
...
- [x] 04-03-PLAN.md — Zoomable timeline with gap visualization + unified live/recording playback page
